                ...
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <form className="d-flex w-100" role="search">
                            <input className="form-control me-2" type="search w-50" placeholder="Search" aria-label="Search" />
                            ...
                            {localStorage.getItem("login") ?
                                <li className="nav-item dropdown">
                                    <Link className="nav-link text-light dropdown-toggle" to="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        <img src={pic} alt='pic' width='40px' height='40px' style={{ borderRadius: "50%" }}></img>
                                    </Link>
                                    <ul className="dropdown-menu">
                                        <li><Link className="dropdown-item text-primary" to="/profile"><AccountCircleIcon/>Profile</Link></li>
                                        <li><Link className="dropdown-item text-primary" to="/cart"><Badge color="secondary" badgeContent={qty}>
                                            <ShoppingCartIcon />
                                        </Badge></Link></li>
