        ...
        <div className='container-fluid'>
            <div className='row'>
                ...
                <div className='col-xl-10 col-lg-9 col-md-8 col-sm-6 col-12'>
                    <h5 className='background text-light text-center p-2'>Update Product Page</h5>
                    <form onSubmit={postData}>
                        ...
                        <div className="mb-3">
                            ...
                            <textarea type="text" className="form-control" onChange={getData} name='description' rows={5} placeholder='Enter Description' value={product.description} />
                        </div>
                        <div className='row mb-3'>
                            <div className="col-md-3 col-sm-6 col-12">
