                    ...
                    <h5 className='background text-light text-center p-2'>Single Checkout Page</h5>
                    {
                        checkout ?
                            <>
                                ...
                                <h5 className='background text-light text-center p-2'>Checkout Products</h5>
                            ...
                            <Link to="/admin-home" className='btn background text-light my-5 p-2 w-100'>No Item to Display!!! Back to Home</Link>
                    }
                </div>
            </div>
        </div>
