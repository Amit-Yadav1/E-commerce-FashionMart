                                ...
                                <tbody>
                                    ...
                                    </tr>
                                    {
                                        shoppingCart.map((item, index) => {
                                            return <tr key={index}>
                                                <td><img src={item.pic1} alt='pic' className='rounded' style={{ width: "50px", height: "50px" }} /></td>
                                                <td>{item.name}</td>
                                                <td>{item.color}</td>
                                                <td>{item.size}</td>
                            ...
                            <tbody>
                                ...
                                </tr>
                                {
                                    shoppingCart.length > 0 ?
                                        <tr>
                                            <th colSpan={2}><button className='btn background text-light p-2 w-100 btn-sm' onClick={placeOrder}>Place Order</button></th>
                                        </tr>
                                        : ""
                                }
                            </tbody>
