        ...
        <div className='container fluid'>
            <div className='row'>
                <div className='col-md-6 col-12'>
                    <div className='background text-light text-center p-3 mb-1'>amityadav222000@gmail.com</div>
                    <div className='background text-light text-center p-3 mb-1'>9889991068</div>
                    <div className='background text-light text-center p-3 mb-1'>New Ashok Nagar</div>
                    <div className="mapouter"><div className="gmap_canvas"><iframe width="100%" height="430px" id="gmap_canvas"
                        src="https://maps.google.com/maps?q=Noida%20Sector%2016,%20A-43&t=&z=13&ie=UTF8&iwloc=&output=embed"
