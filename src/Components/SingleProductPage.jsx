                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item md={6} xs={12}>
                        ...
                        <div className='d-flex justify-content-between'>
                            <Link to="/cart" className='btn background text-light text-center btn-sm' style={{width:"49%"}} onClick={()=>{cartdispatch({type:"ADD_TO_CART",product:product})}}>Add to Card</Link>
